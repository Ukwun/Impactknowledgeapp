...
const LIVE_FACILITATOR_FRAMEWORK = {
  ...
  assessmentProgressionRecognition: {
    assessmentSignals: [
      'Quizzes and short tests',
      'Worksheets and practical tasks',
      'Reflection journals',
      'Project submissions',
      'Live classroom attendance',
      'Participation and presentation scores',
    ],
    progressionRules: {
      ...
      ruleStatement: 'A learner moves forward when completion, assessment, project, and live participation benchmarks are met.',
    },
    recognitionSystem: [
      'Skill badges',
      'Value badges',
      ...
      'Showcase awards',
      'Facilitator recommendation markers',
    ],
  },
  essentialProductRequirements: [
    'Mobile-first classroom design',
    'Low-bandwidth viewing mode',
    'Age-based access permissions',
    'Parent access for younger learners',
    'School admin dashboard',
    'Cohort-based enrolment and scheduling',
    'Replay library',
    'Assignment upload and review workflow',
    'Certificate engine',
    'Moderation and code-of-conduct controls',
    'WhatsApp, email, and SMS reminder integrations',
    'Analytics for activation, retention, attendance, and completion',
  ],
  recommendedNextDevelopmentDocuments: [
    'Detailed wireframe and page-by-page app structure',
    'Database and CMS schema',
    'Facilitator operations manual',
    'Term-by-term curriculum map for each level',
    'Assessment rubrics and badge logic',
    'School onboarding and cohort management workflow',
